...
namespace MJTradier
{
    public partial class Form1 : Form
    {
        ...
        public StreamWriter swLogPlus07Cnt4 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp07cnt4.txt", FileMode.Create));
        public StreamWriter swLogPlus07Cnt6 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp07cnt6.txt", FileMode.Create));
        public StreamWriter swLogPlus07Cnt8 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp07cnt8.txt", FileMode.Create));
        public StreamWriter swLogPlus07Cnt10 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp07cnt10.txt", FileMode.Create));
        public StreamWriter swLogPlus07Cnt12 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp07cnt12.txt", FileMode.Create));
        public StreamWriter swLogPlus07Cnt15 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp07cnt15.txt", FileMode.Create));

        public StreamWriter swLogPlus09Cnt4 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp09cnt4.txt", FileMode.Create));
        public StreamWriter swLogPlus09Cnt6 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp09cnt6.txt", FileMode.Create));
        public StreamWriter swLogPlus09Cnt8 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp09cnt8.txt", FileMode.Create));
        public StreamWriter swLogPlus09Cnt10 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp09cnt10.txt", FileMode.Create));
        public StreamWriter swLogPlus09Cnt12 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp09cnt12.txt", FileMode.Create));
        public StreamWriter swLogPlus09Cnt15 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogUp09cnt15.txt", FileMode.Create));
        ...
        public StreamWriter swLog60Crush = new StreamWriter(new FileStream(sMessageLogPath + "messageLog60Crush.txt", FileMode.Create));
        public StreamWriter swLog70Crush = new StreamWriter(new FileStream(sMessageLogPath + "messageLog70Crush.txt", FileMode.Create));
        public StreamWriter swLog80Crush = new StreamWriter(new FileStream(sMessageLogPath + "messageLog80Crush.txt", FileMode.Create));

        public StreamWriter swLogM50Max = new StreamWriter(new FileStream(sMessageLogPath + "messageLogM50Max.txt", FileMode.Create));
        public StreamWriter swLogM60Max = new StreamWriter(new FileStream(sMessageLogPath + "messageLogM60Max.txt", FileMode.Create));
        public StreamWriter swLogM70Max = new StreamWriter(new FileStream(sMessageLogPath + "messageLogM70Max.txt", FileMode.Create));
        ...
        public StreamWriter swLogAbsoluteEverage20 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogAbsoluteEverage20.txt", FileMode.Create));
        public StreamWriter swLogRelativeEverage20 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogRelativeEverage20.txt", FileMode.Create));
        public StreamWriter swLogAbsoluteRecent20 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogAbsoluteRecent20.txt", FileMode.Create));
        public StreamWriter swLogRelativeRecent20 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogRelativeRecent20.txt", FileMode.Create));
        public StreamWriter swLogAbsoluteRight20 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogAbsoluteRight20.txt", FileMode.Create));
        public StreamWriter swLogRelativeRight20 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogRelativeRight20.txt", FileMode.Create));
        public StreamWriter swLogRelativeMove = new StreamWriter(new FileStream(sMessageLogPath + "messageLogRelativeMove.txt", FileMode.Create));
        public StreamWriter swLogAbsoluteMove = new StreamWriter(new FileStream(sMessageLogPath + "messageLogAbsoluteMove.txt", FileMode.Create));
        public StreamWriter swLogAbsoluteMax50 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogAbsoluteMax50.txt", FileMode.Create));

        
        public StreamWriter swLogTenMinutePower002 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinutePower002.txt", FileMode.Create));
        public StreamWriter swLogTenMinutePower003 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinutePower003.txt", FileMode.Create));
        public StreamWriter swLogTenMinutePower004 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinutePower004.txt", FileMode.Create));
        public StreamWriter swLogTenMinutePower005 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinutePower005.txt", FileMode.Create));
        public StreamWriter swLogTenMinutePower006 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinutePower006.txt", FileMode.Create));

        public StreamWriter swLogContinuosCnt3 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosCnt3.txt", FileMode.Create));
        public StreamWriter swLogContinuosCnt4 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosCnt4.txt", FileMode.Create));
        public StreamWriter swLogContinuosCnt5 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosCnt5.txt", FileMode.Create));
        public StreamWriter swLogContinuosCnt6 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosCnt6.txt", FileMode.Create));

        public StreamWriter swLogTenMinuteCount6 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteCount6.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteCount7 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteCount7.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteCount8 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteCount8.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteCount9 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteCount9.txt", FileMode.Create));

        public StreamWriter swLogTenMinuteMaxMove002 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteMaxMove002.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteMaxMove003 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteMaxMove003.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteMaxMove004 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteMaxMove004.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteMaxMove005 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteMaxMove005.txt", FileMode.Create));
        public StreamWriter swLogTenMinuteMaxMove006 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogTenMinuteMaxMove006.txt", FileMode.Create));

        public StreamWriter swLogContinuosPower002 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosPower002.txt", FileMode.Create));
        public StreamWriter swLogContinuosPower003 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosPower003.txt", FileMode.Create));
        public StreamWriter swLogContinuosPower004 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosPower004.txt", FileMode.Create));
        public StreamWriter swLogContinuosPower005 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosPower005.txt", FileMode.Create));
        public StreamWriter swLogContinuosPower006 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogContinuosPower006.txt", FileMode.Create));

        public StreamWriter swLogPlus07AndMinus30 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus07AndMinus30.txt", FileMode.Create));
        public StreamWriter swLogPlus07AndMinus50 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus07AndMinus50.txt", FileMode.Create));
        public StreamWriter swLogPlus07AndMinus70 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus07AndMinus70.txt", FileMode.Create));
        public StreamWriter swLogPlus07AndMinus90 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus07AndMinus90.txt", FileMode.Create));
        public StreamWriter swLogPlus07AndMinus110 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus07AndMinus110.txt", FileMode.Create));

        public StreamWriter swLogPlus09AndMinus30 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus09AndMinus30.txt", FileMode.Create));
        public StreamWriter swLogPlus09AndMinus50 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus09AndMinus50.txt", FileMode.Create));
        public StreamWriter swLogPlus09AndMinus70 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus09AndMinus70.txt", FileMode.Create));
        public StreamWriter swLogPlus09AndMinus90 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus09AndMinus90.txt", FileMode.Create));
        public StreamWriter swLogPlus09AndMinus110 = new StreamWriter(new FileStream(sMessageLogPath + "messageLogPlus09AndMinus110.txt", FileMode.Create));

        public const int REC_NUM = 26; // 0 시간 1 시가 2 종가 3 고가 4 저가 5 평균추세 6 근접추세 7 평균분산 8 근접분산 9 초근접추세 10 초근접분산 11 초기추세 12 기본각도 13 평균각도 14 근접각도 15 초근접각도 16 최대값각도 17 최저값각도
            ...
            else if (e.sRealType.Equals("주식체결")) // ##체결##
            {
                ...
                if (isMarketStart && !ea[nCurIdx].isExcluded) // 장이 시작 안했으면 접근 금지
                {
                    ...
                    if (nKospiIndexIdxPointer != nKospiIndexMinPointer)// && fInitKospiIndexUnGap != 0) // 기록된 포인터와 새로운 포인터가 다르면 (과거처리)
                    {
                        ...
                        if (nKospiIndexIdxPointer > BRUSH) // 추세 확인
                        {
                            ...
                            for (int j = 0; j < nRandomi; j++)
                            {
                                ...
                                if (((double)SubTimeToTimeAndSec(nSharedTime, (int)arrKospiIndex[nFlowIdx, 0]) / 60) < 10)
                                    fInclination += (fCurKospiIndexUnGap - arrKospiIndex[nFlowIdx, 2]) / 10;
                                else
                                ...
                                if (((double)SubTimeToTimeAndSec(nSharedTime, (int)arrKospiIndex[nRecentFlowIdx, 0]) / 60) < 10)
                                    fRecentInclination += (fCurKospiIndexUnGap - arrKospiIndex[nRecentFlowIdx, 2]) / 10;
                                else
                                ...
                                if (((double)SubTimeToTimeAndSec(nSharedTime, (int)arrKospiIndex[nRightFlowIdx, 0]) / 60) < 10)
                                    fRightInclination += (fCurKospiIndexUnGap - arrKospiIndex[nRightFlowIdx, 2]) / 10;
                                else
                            ...
                            fResultInitInclination = (fCurKospiIndexUnGap - fInitKospiIndexUnGap) / 10;
                    ...
                    if (nKosdaqIndexIdxPointer != nKosdaqIndexMinPointer ) //`&& fInitKosdaqIndexUnGap != 0) // 기록된 포인터와 새로운 포인터가 다르면 (과거처리)
                    {
                        ...
                        if (nKosdaqIndexIdxPointer > BRUSH) // 추세 확인
                        {
                            ...
                            for (int j = 0; j < nRandomi; j++)
                            {
                                ...
                                if (((double)SubTimeToTimeAndSec(nSharedTime, (int)arrKosdaqIndex[nFlowIdx, 0]) / 60) < 10)
                                    fInclination += (fInitKosdaqIndexUnGap - arrKosdaqIndex[nFlowIdx, 2]) / 10;
                                else
                                ...
                                if (((double)SubTimeToTimeAndSec(nSharedTime, (int)arrKosdaqIndex[nRecentFlowIdx, 0]) / 60) < 10)
                                    fRecentInclination += (fInitKosdaqIndexUnGap - arrKosdaqIndex[nRecentFlowIdx, 2]) / 10;
                                else
                                ...
                                if(((double)SubTimeToTimeAndSec(nSharedTime, (int)arrKosdaqIndex[nRightFlowIdx, 0]) / 60) < 10)
                                    fRightInclination += (fInitKosdaqIndexUnGap - arrKosdaqIndex[nRightFlowIdx, 2]) / 10;
                                else
                            ...
                            fResultRecentInclinationEvg = fRecentInclination / nRecentInclinationCnt; // 근접추세선
                            fResultRightInclinationEvg = fRightInclination / nRightInclinationCnt;
                            fResultInitInclination = (fInitKosdaqIndexUnGap - fInitKosdaqIndexUnGap) / 10;
                    ...
                    if (ea[nCurIdx].nIdxPointer != nMinPointer) // 기록된 포인터와 새로운 포인터가 다르면 (과거처리)
                    {
                        ...
                        if (ea[nCurIdx].nIdxPointer > BRUSH) // 기록 파트
                        {
                            //////////////////////////////////////////////////////////
                            /// 10분 간 1분단위 데이터 기록
                            ea[nCurIdx].fTenMinutePower = 0; // 가격상승 정도
                            ea[nCurIdx].nTenMinuteUpCnt = 0; // 10분간 상승횟수 
                            ea[nCurIdx].fTenMinuteMaxMove = 0; // 10분간 1분단위 최대상승 정도
                            ea[nCurIdx].nContinuosUpCnt = 0; // 연속가격상승 횟수
                            double fAMinuteMove;
                            bool isContinuosUp = false;

                            for (int nStartIdx = ea[nCurIdx].nIdxPointer - 1; nStartIdx >= ea[nCurIdx].nIdxPointer - 10; nStartIdx--)
                            {
                                fAMinuteMove = (ea[nCurIdx].arrRecord[nStartIdx, 2] - ea[nCurIdx].arrRecord[nStartIdx, 1]) / (double)(ea[nCurIdx].nTodayStartPrice);

                                if (fAMinuteMove > 0) // 이 시점에서 종가가 시가보다 높냐?
                                {
                                    ea[nCurIdx].nTenMinuteUpCnt++;
                                ...
                                if(ea[nCurIdx].fTenMinuteMaxMove == 0 || ea[nCurIdx].fTenMinuteMaxMove < fAMinuteMove) // 최대가격 상승정도 기록
                                {
                                    ea[nCurIdx].fTenMinuteMaxMove = fAMinuteMove;
                                }

                            }

                            ea[nCurIdx].fTenMinutePower = (ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer - 1, 2] - ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer - 10, 1]) / (double)(ea[nCurIdx].nTodayStartPrice);
                            ea[nCurIdx].fContinuosUpPower = (ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer - 1, 2] - ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer - ea[nCurIdx].nContinuosUpCnt, 1]) / (double)(ea[nCurIdx].nTodayStartPrice);
                            ...
                            double fAbsoluteTotalSlope = 0;
                            double fAbsoluteEverageSlope = 0;
                            double fRelativeTotalSlope = 0;
                            double fRelativeEverageSlope = 0;
                            int nSlopeCount = 0;

                            double fAbsoluteTotalRecentSlope = 0;
                            double fAbsoluteEverageRecentSlope = 0;
                            double fRelativeTotalRecentSlope = 0;
                            double fRelativeEverageRecentSlope = 0;
                            int nRecentSlopeCount = 0;

                            double fAbsoluteTotalRightSlope = 0;
                            double fAbsoluteEverageRightSlope = 0;
                            double fRelativeTotalRightSlope = 0;
                            double fRelativeEverageRightSlope = 0;
                            int nRightSlopeCount = 0;

                            double fRelativeInitSlope;
                            double fRelativeMaxSlope;
                            double fRelativeMinSlope;

                            double fAbsoluteInitSlope;
                            double fAbsoluteMaxSlope;
                            double fAbsoluteMinSlope;

                            double fStartPointY;
                            double fStartPointRecentY;
                            double fStartPointRightY;
                            double fStartPointVariance = 0;
                            double fStartPointRecentVariance = 0;
                            double fStartPointRightVariance = 0;


                            double fEndPointY;
                            double fEndPointRecentY;
                            double fEndPointRightY;
                            double fEndPointVariance = 0;
                            double fEndPointRecentVariance = 0;
                            double fEndPointRightVariance = 0;


                            double fInitPointY;
                            double fInitPointVariance = 0;
                            ...
                            for (int j = 0; j < nRandomi; j++)
                            {
                                ...
                                if(((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nFlowIdx, 0]) / 60) < FIXED_IDX)
                                    fRelativeTotalSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nFlowIdx, 2]) / FIXED_IDX;
                                else
                                    fRelativeTotalSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nFlowIdx, 2]) / ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nFlowIdx, 0]) / 60);
                                fAbsoluteTotalSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nFlowIdx, 2]) / FIXED_IDX;
                                nSlopeCount++;
                                ...
                                if (((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRecentFlowIdx, 0]) / 60) < FIXED_IDX)
                                    fRelativeTotalRecentSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nRecentFlowIdx, 2]) / FIXED_IDX;
                                else
                                    fRelativeTotalRecentSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nRecentFlowIdx, 2]) / ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRecentFlowIdx, 0]) / 60);
                                fAbsoluteTotalRecentSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nRecentFlowIdx, 2]) / FIXED_IDX;
                                nRecentSlopeCount++;
                                ...
                                if(((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRightFlowIdx, 0]) / 60) < FIXED_IDX)
                                    fRelativeTotalRightSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nRightFlowIdx, 2]) / FIXED_IDX;
                                else
                                    fRelativeTotalRightSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nRightFlowIdx, 2]) / ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRightFlowIdx, 0]) / 60);
                                fAbsoluteTotalRightSlope += (ea[nCurIdx].nFs - ea[nCurIdx].arrRecord[nRightFlowIdx, 2]) / FIXED_IDX;
                                nRightSlopeCount++;

                            }

                            fRelativeEverageSlope = fRelativeTotalSlope / nSlopeCount; // 상대적평균추세 기울기
                            fAbsoluteEverageSlope = fAbsoluteTotalSlope / nSlopeCount; // 절대적평균추세 기울기

                            fRelativeEverageRecentSlope = fRelativeTotalRecentSlope / nRecentSlopeCount; // 상대적근접추세 기울기
                            fAbsoluteEverageRecentSlope = fAbsoluteTotalRecentSlope / nRecentSlopeCount; // 절대적근접추세 기울기

                            fRelativeEverageRightSlope = fRelativeTotalRightSlope / nRightSlopeCount; // 상대적초근접추세 기울기
                            fAbsoluteEverageRightSlope = fAbsoluteTotalRightSlope / nRightSlopeCount; // 절대적초근접추세 기울기

                            double fTimeForSlope = SubTimeToTimeAndSec(nSharedTime, nFirstTime) / 60.0;
                            /*
                             * 상대적초기추세 기울기
                             * 상대적최대값추세 기울기
                             * 상대적최소값추세 기울기
                             */
                            if (fTimeForSlope < FIXED_IDX)
                            {
                                fRelativeInitSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nTodayStartPrice) / FIXED_IDX;
                                fRelativeMaxSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nMaxFs) / FIXED_IDX;
                                fRelativeMinSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nRealMinFs) / FIXED_IDX;
                            }
                            else
                            {
                                fRelativeInitSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nTodayStartPrice) / fTimeForSlope;
                                fRelativeMaxSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nMaxFs) / fTimeForSlope;
                                fRelativeMinSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nRealMinFs) / fTimeForSlope;
                            }
                            fAbsoluteInitSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nTodayStartPrice) / FIXED_IDX; // 절대적초기추세 기울기
                            fAbsoluteMaxSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nMaxFs) / FIXED_IDX; // 절대적최대값추세 기울기
                            fAbsoluteMinSlope = (ea[nCurIdx].nFs - ea[nCurIdx].nRealMinFs) / FIXED_IDX; // 절대적최소값추세 기울기


                            ea[nCurIdx].nUpCntOfSlope = 0;
                            ea[nCurIdx].fUpRatioOfSlope = 0;
                            ea[nCurIdx].fDiffOfSlope = 0;
                            double fYOfInitSlope;
                            int nIdxOfInitSlope;
                            // 분산 구하기
                            for (int k = 0; k < nRandomi; k++)
                            {
                                nFlowIdxDiff = rand.Next(ea[nCurIdx].nIdxPointer);
                                fStartPointY = fRelativeEverageSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nTodayStartPrice;
                                fEndPointY = fRelativeEverageSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nFs - fRelativeEverageSlope * ((double)SubTimeToTimeAndSec(nSharedTime, nFirstTime) / 60); // 기울기에 따른 linear 함수
                                fStartPointVariance += Math.Pow((fStartPointY - ea[nCurIdx].arrRecord[nFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭
                                fEndPointVariance += Math.Pow((fEndPointY - ea[nCurIdx].arrRecord[nFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭

                                fInitPointY = fRelativeInitSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nTodayStartPrice;
                                fInitPointVariance += Math.Pow((fInitPointY - ea[nCurIdx].arrRecord[nFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭
                                ...
                                fStartPointRecentY = fRelativeEverageRecentSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRecentFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nTodayStartPrice;
                                fEndPointRecentY = fRelativeEverageRecentSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRecentFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nFs - fRelativeEverageRecentSlope * ((double)SubTimeToTimeAndSec(nSharedTime, nFirstTime) / 60); // 기울기에 따른 linear 함수
                                fStartPointRecentVariance += Math.Pow((fStartPointRecentY - ea[nCurIdx].arrRecord[nRecentFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭
                                fEndPointRecentVariance += Math.Pow((fEndPointRecentY - ea[nCurIdx].arrRecord[nRecentFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭
                                ...
                                fStartPointRightY = fRelativeEverageRightSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRightFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nTodayStartPrice;
                                fEndPointRightY = fRelativeEverageRightSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nRightFlowIdxDiff, 0]) / 60) + ea[nCurIdx].nFs - fRelativeEverageRightSlope * ((double)SubTimeToTimeAndSec(nSharedTime, nFirstTime) / 60); // 기울기에 따른 linear 함수
                                fStartPointRightVariance += Math.Pow((fStartPointRightY - ea[nCurIdx].arrRecord[nRightFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭
                                fEndPointRightVariance += Math.Pow((fEndPointRightY - ea[nCurIdx].arrRecord[nRightFlowIdxDiff, 2]) / nMarketGap, 2); // 변동폭

                                nIdxOfInitSlope = rand.Next(BRUSH, ea[nCurIdx].nIdxPointer);
                                fYOfInitSlope = fAbsoluteInitSlope * ((double)SubTimeToTimeAndSec(nSharedTime, (int)ea[nCurIdx].arrRecord[nIdxOfInitSlope, 0]) / 60) + +ea[nCurIdx].nTodayStartPrice;
                                if(fYOfInitSlope < ea[nCurIdx].arrRecord[nIdxOfInitSlope, 2])
                                {
                                    ea[nCurIdx].nUpCntOfSlope++;
                                }
                                ea[nCurIdx].fDiffOfSlope += ((fYOfInitSlope - ea[nCurIdx].arrRecord[nIdxOfInitSlope, 2]) / nMarketGap) * 5;
                            }
                            ea[nCurIdx].fUpRatioOfSlope = (double)ea[nCurIdx].nUpCntOfSlope / nRandomi;

                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 8]++;

                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 5]  = ea[nCurIdx].fRelativeEverageSlope = fRelativeEverageSlope / nMarketGap;  // 평균추세
                            ea[nCurIdx].fRelativeRecentSlope = fRelativeEverageRecentSlope / nMarketGap; // 근접추세
                            ea[nCurIdx].fRelativeRightSlope = fRelativeEverageRightSlope / nMarketGap; // 초근접추세d
                            ea[nCurIdx].fRelativeInitSlope = fRelativeInitSlope / nMarketGap; // 상대적 초기추세 기울기
                            ea[nCurIdx].fRelativeMaxSlope = fRelativeMaxSlope / nMarketGap;
                            ea[nCurIdx].fRelativeMinSlope = fRelativeMinSlope / nMarketGap;

                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 6] = ea[nCurIdx].fAbsoluteEverageSlope = fAbsoluteEverageSlope / nMarketGap;  // 평균추세
                            ea[nCurIdx].fAbsoluteRecentSlope = fAbsoluteEverageRecentSlope / nMarketGap; // 근접추세
                            ea[nCurIdx].fAbsoluteRightSlope = fAbsoluteEverageRightSlope / nMarketGap; // 초근접추세
                            ea[nCurIdx].fAbsoluteInitSlope = fAbsoluteInitSlope / nMarketGap; // 상대적 초기추세 기울기
                            ea[nCurIdx].fAbsoluteMaxSlope = fAbsoluteMaxSlope / nMarketGap;
                            ea[nCurIdx].fAbsoluteMinSlope = fAbsoluteMinSlope / nMarketGap;

                            if(ea[nCurIdx].nIdxPointer <= BRUSH + 10)
                            {
                                ea[nCurIdx].fAbsoluteMove = GetAngleBetween(0, ea[nCurIdx].fAbsoluteEverageSlope) - GetAngleBetween(0, ea[nCurIdx].arrRecord[BRUSH + 1, 6]);
                                ea[nCurIdx].fRelativeMove = GetAngleBetween(0, ea[nCurIdx].fRelativeEverageSlope) - GetAngleBetween(0, ea[nCurIdx].arrRecord[BRUSH + 1, 5]);
                            }
                            else
                            {
                                ea[nCurIdx].fAbsoluteMove = GetAngleBetween(0, ea[nCurIdx].fAbsoluteEverageSlope) - GetAngleBetween(0, ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer - 10, 6]);
                                ea[nCurIdx].fRelativeMove = GetAngleBetween(0, ea[nCurIdx].fRelativeEverageSlope) - GetAngleBetween(0, ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer - 10, 5]);
                            }
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 14] += ea[nCurIdx].fRelativeMove;
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15] = ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 14] / ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 8];


                            ea[nCurIdx].fRelativeEverageAngle = GetAngleBetween(0, ea[nCurIdx].fRelativeEverageSlope);
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 7] += ea[nCurIdx].fRelativeEverageAngle;
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9] = ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 7] / ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 8]; // 평균평균

                            ea[nCurIdx].fRelativeRecentAngle = GetAngleBetween(0, ea[nCurIdx].fRelativeRecentSlope);
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 10] += ea[nCurIdx].fRelativeRecentAngle;
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11] = ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 10] / ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 8]; // 평균근접

                            ea[nCurIdx].fRelativeRightAngle = GetAngleBetween(0, ea[nCurIdx].fRelativeRightSlope);
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 12] += ea[nCurIdx].fRelativeRightAngle;
                            ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13] = ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 12] / ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 8]; // 평균초근접

                            ea[nCurIdx].fRelativeInitAngle = GetAngleBetween(0, ea[nCurIdx].fRelativeInitSlope);
                            


                            ea[nCurIdx].fRelativeMaxAngle = GetAngleBetween(0, ea[nCurIdx].fRelativeMaxSlope);
                            ea[nCurIdx].fRelativeMinAngle = GetAngleBetween(0, ea[nCurIdx].fRelativeMinSlope);

                            ea[nCurIdx].fAbsoluteEverageAngle = GetAngleBetween(0, ea[nCurIdx].fAbsoluteEverageSlope);
                            ea[nCurIdx].fAbsoluteRecentAngle = GetAngleBetween(0, ea[nCurIdx].fAbsoluteRecentSlope);
                            ea[nCurIdx].fAbsoluteRightAngle = GetAngleBetween(0, ea[nCurIdx].fAbsoluteRightSlope);
                            ea[nCurIdx].fAbsoluteInitAngle = GetAngleBetween(0 , ea[nCurIdx].fAbsoluteInitSlope);
                            ea[nCurIdx].fAbsoluteMaxAngle = GetAngleBetween(0, ea[nCurIdx].fAbsoluteMaxSlope);
                            ea[nCurIdx].fAbsoluteMinAngle = GetAngleBetween(0, ea[nCurIdx].fAbsoluteMinSlope);
                            if (ea[nCurIdx].fPrevAbsoluteInitAngle != 0)
                            {
                                ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 16] += ea[nCurIdx].fAbsoluteInitAngle - ea[nCurIdx].fPrevAbsoluteInitAngle;
                                ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17] = ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 16] / ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 8];
                            }
                            ea[nCurIdx].fPrevAbsoluteInitAngle = ea[nCurIdx].fAbsoluteInitAngle;


                            if (!ea[nCurIdx].isM50Max && ea[nCurIdx].fAbsoluteMaxAngle <= -50)
                            {
                                ea[nCurIdx].isM50Max = true;
                                ea[nCurIdx].nM50MaxTime = nSharedTime;
                            }
                            if (!ea[nCurIdx].isM60Max && ea[nCurIdx].fAbsoluteMaxAngle <= -60)
                            {
                                ea[nCurIdx].isM60Max = true;
                                ea[nCurIdx].nM60MaxTime = nSharedTime;
                            }
                            if (!ea[nCurIdx].isM70Max && ea[nCurIdx].fAbsoluteMaxAngle <= -70)
                            {
                                ea[nCurIdx].isM70Max = true;
                                ea[nCurIdx].nM70MaxTime = nSharedTime;
                            }
                            
                            if(ea[nCurIdx].fRelativeRecentAngle > 20)
                            {
                                swLogRelativeRecent20.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                        );
                            }
                            if (ea[nCurIdx].fRelativeRightAngle > 20)
                            {
                                swLogRelativeRight20.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                        ...
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (ea[nCurIdx].fRelativeEverageAngle > 20)
                            { 
                                swLogRelativeEverage20.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                        );   // JMJ babo mungchung-e
                            }
                            if (ea[nCurIdx].fAbsoluteEverageAngle > 20)
                            {
                                swLogAbsoluteEverage20.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (ea[nCurIdx].fRelativeMove > 10)
                            {
                                swLogRelativeMove.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (ea[nCurIdx].fAbsoluteMove > 10)
                            {
                                swLogAbsoluteMove.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (ea[nCurIdx].fAbsoluteMinAngle > 50)
                            {
                                swLogAbsoluteMax50.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (!ea[nCurIdx].isM50Done && nSharedTime > AddTimeBySec(nFirstTime, 600))
                            {
                                
                                if (ea[nCurIdx].isM50Max && ea[nCurIdx].fAbsoluteMinAngle + ea[nCurIdx].fAbsoluteMaxAngle > 0 && SubTimeToTime(nSharedTime, ea[nCurIdx].nM50MaxTime) > 200)
                                {
                                    
                                    swLogM50Max.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                        );
                                    ea[nCurIdx].isM50Done = true;
                                }
                            }

                            if (!ea[nCurIdx].isM60Done)
                            {
                                
                                if (ea[nCurIdx].isM60Max && ea[nCurIdx].fAbsoluteMinAngle + ea[nCurIdx].fAbsoluteMaxAngle > 0 && SubTimeToTime(nSharedTime, ea[nCurIdx].nM60MaxTime) > 200)
                                {

                                    swLogM60Max.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                        );
                                    ea[nCurIdx].isM60Done = true;
                                }
                            }

                            if (!ea[nCurIdx].isM70Done)
                            {
                                
                                if (ea[nCurIdx].isM70Max && ea[nCurIdx].fAbsoluteMinAngle + ea[nCurIdx].fAbsoluteMaxAngle > 0 && SubTimeToTime(nSharedTime, ea[nCurIdx].nM70MaxTime) > 200)
                                {

                                    swLogM70Max.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                        );
                                    ea[nCurIdx].isM70Done = true;
                                }
                            }
                            ...
                            if (ea[nCurIdx].fAbsoluteMinAngle >= 60 && !ea[nCurIdx].is60Crush)
                            {
                                ea[nCurIdx].is60Crush = true;
                                swLog60Crush.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (ea[nCurIdx].fAbsoluteMinAngle >= 70 && !ea[nCurIdx].is70Crush)
                            {
                                ea[nCurIdx].is70Crush = true;
                                swLog70Crush.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            if (ea[nCurIdx].fAbsoluteMinAngle >= 80 && !ea[nCurIdx].is80Crush)
                            {
                                ea[nCurIdx].is80Crush = true;
                                swLog80Crush.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" +
                        ea[nCurIdx].sMarketGubunTag + "\t" +
                        "#Relative\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + "방향값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 15], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 17], nR).ToString() + "\t" + "이상값" + "\t" + Math.Round(ea[nCurIdx].fUpRatioOfSlope, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fDiffOfSlope, nR).ToString() + "\t" + "평균값" + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 9], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 11], nR).ToString() + "\t" + Math.Round(ea[nCurIdx].arrRecord[ea[nCurIdx].nIdxPointer, 13], nR).ToString() + "\t" + "각도" + "\t" + Math.Round(ea[nCurIdx].fRelativeMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fRelativeMinAngle, nR).ToString() + "\t" +
                        "#Absolute\t" + nSharedTime.ToString() + "\t" + "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString() + "\t" +
                        "#Variation\t" + "Start\t" + Math.Round(ea[nCurIdx].fStartPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fStartPointRightVariance, nR).ToString() + "\tEND\t" + Math.Round(ea[nCurIdx].fEndPointEverageVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRecentVariance, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fEndPointRightVariance, nR).ToString() + "\tInit\t" + Math.Round(ea[nCurIdx].fInitPointEverageVariance, nR).ToString()
                            ...
                            /////////////////////////////////////////////////////////
                            /// 
                            if (ea[nCurIdx].fTenMinutePower >= 0.02)
                            {
                                swLogTenMinutePower002.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                                     "Angle" + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMove, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteInitAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteEverageAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRecentAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteRightAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMaxAngle, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fAbsoluteMinAngle, nR).ToString()
                                     );
                            }
                            if (ea[nCurIdx].fTenMinutePower >= 0.03)
                            {
                                swLogTenMinutePower003.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinutePower >= 0.04)
                            {
                                swLogTenMinutePower004.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinutePower >= 0.05)
                            {
                                swLogTenMinutePower005.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinutePower >= 0.06)
                            {
                                swLogTenMinutePower006.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nContinuosUpCnt >= 3)
                            {
                                swLogContinuosCnt3.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nContinuosUpCnt >= 4)
                            {
                                swLogContinuosCnt4.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nContinuosUpCnt >= 5)
                            {
                                swLogContinuosCnt5.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nContinuosUpCnt >= 6)
                            {
                                swLogContinuosCnt6.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nTenMinuteUpCnt >= 6)
                            {
                                swLogTenMinuteCount6.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nTenMinuteUpCnt >= 7)
                            {
                                swLogTenMinuteCount7.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nTenMinuteUpCnt >= 8)
                            {
                                swLogTenMinuteCount8.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].nTenMinuteUpCnt >= 9)
                            {
                                swLogTenMinuteCount9.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinuteMaxMove >= 0.02)
                            {
                                swLogTenMinuteMaxMove002.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinuteMaxMove >= 0.03)
                            {
                                swLogTenMinuteMaxMove003.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinuteMaxMove >= 0.04)
                            {
                                swLogTenMinuteMaxMove004.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinuteMaxMove >= 0.05)
                            {
                                swLogTenMinuteMaxMove005.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fTenMinuteMaxMove >= 0.06)
                            {
                                swLogTenMinuteMaxMove006.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fContinuosUpPower >= 0.02)
                            {
                                swLogContinuosPower002.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fContinuosUpPower >= 0.03)
                            {
                                swLogContinuosPower003.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fContinuosUpPower >= 0.04)
                            {
                                swLogContinuosPower004.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fContinuosUpPower >= 0.05)
                            {
                                swLogContinuosPower005.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            if (ea[nCurIdx].fContinuosUpPower >= 0.06)
                            {
                                swLogContinuosPower006.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                            ...
                            /// 
                            ///////////////////////////////////////////////////////////
                            ea[nCurIdx].fStartPointEverageVariance = Math.Sqrt(fStartPointVariance);
                            ea[nCurIdx].fStartPointRecentVariance = Math.Sqrt(fStartPointRecentVariance);
                            ea[nCurIdx].fStartPointRightVariance = Math.Sqrt(fStartPointRightVariance);

                            ea[nCurIdx].fEndPointEverageVariance = Math.Sqrt(fEndPointVariance);
                            ea[nCurIdx].fEndPointRecentVariance = Math.Sqrt(fEndPointRecentVariance);
                            ea[nCurIdx].fEndPointRightVariance = Math.Sqrt(fEndPointRightVariance);

                            ea[nCurIdx].fInitPointEverageVariance = Math.Sqrt(fInitPointVariance);
                        }
                        ...
                        )
                    {
                        ...
                        Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPurePerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaRatioVal, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fHogaPerTrade, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fSharePerHoga, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyUp, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerOnlyDown, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerWithoutGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString());
                    }
                    ...
                    if (ea[nCurIdx].fPowerJar >= 2)
                    {
                        swLogPower2.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if (ea[nCurIdx].fCurSpeed >= 10)
                    {
                        ...
                        swLogSpeed10.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if (ea[nCurIdx].fCurSpeed >= 20)
                    {
                        ...
                        swLogSpeed20.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if (ea[nCurIdx].fCurSpeed >= 30)
                    {
                        ...
                        swLogSpeed30.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if (ea[nCurIdx].fCurSpeed >= 40)
                    {
                        ...
                        swLogSpeed40.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus07Cnt15.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07) >= 12)
                    {
                        swLogPlus07Cnt12.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07) >= 10)
                    {
                        swLogPlus07Cnt10.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07) >= 8)
                    {
                        swLogPlus07Cnt8.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07) >= 6)
                    {
                        swLogPlus07Cnt6.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07) >= 4)
                    {
                        swLogPlus07Cnt4.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09) >= 15)
                    {
                        swLogPlus09Cnt15.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09) >= 12)
                    {
                        swLogPlus09Cnt12.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09) >= 10)
                    {
                        swLogPlus09Cnt10.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09) >= 8)
                    {
                        swLogPlus09Cnt8.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09) >= 6)
                    {
                        swLogPlus09Cnt6.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09) >= 4)
                    {
                        swLogPlus09Cnt4.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus07AndMinus30.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus07AndMinus50.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07) >= 70)
                    {
                        swLogPlus07AndMinus70.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07) >= 90)
                    {
                        swLogPlus07AndMinus90.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07) >= 110)
                    {
                        swLogPlus07AndMinus110.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus09AndMinus30.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus09AndMinus50.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus09AndMinus70.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    {
                        swLogPlus09AndMinus90.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
                    ...
                    if ((ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09) >= 110)
                    {
                        swLogPlus09AndMinus110.WriteLine(nSharedTime.ToString() + "\t" + ea[nCurIdx].sCode + "\t" + ea[nCurIdx].sCodeName + "\t" + Math.Round(ea[nCurIdx].fCurSpeed, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fCntPerTime, nR).ToString() + "\t" +
                                     ea[nCurIdx].nFs.ToString() + "\t" + Math.Round(ea[nCurIdx].fStartGap, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPowerJar, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fTenMinutePower, nR).ToString() + "\t" + ea[nCurIdx].nTenMinuteUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fTenMinuteMaxMove, nR).ToString() + "\t" + ea[nCurIdx].nContinuosUpCnt.ToString() + "\t" + Math.Round(ea[nCurIdx].fContinuosUpPower, nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 - ea[nCurIdx].fMinusCnt07, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt07 / (ea[nCurIdx].fPlusCnt07 + ea[nCurIdx].fMinusCnt07 + 1), nR).ToString() + "\t" +
                                     Math.Round(ea[nCurIdx].fPlusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 - ea[nCurIdx].fMinusCnt09, nR).ToString() + "\t" + Math.Round(ea[nCurIdx].fPlusCnt09 / (ea[nCurIdx].fPlusCnt09 + ea[nCurIdx].fMinusCnt09 + 1), nR).ToString() + "\t" +
            ...
            else if (e.sRealType.Equals("장시작시간"))
            {
                ...
                else
                {
                    ...
                    else if (sGubun.Equals("4")) // 장 종료
                    {
                        ...
                        swLogPlus07Cnt4.Close();
                        swLogPlus07Cnt6.Close();
                        swLogPlus07Cnt8.Close();
                        swLogPlus07Cnt10.Close();
                        swLogPlus07Cnt12.Close();
                        swLogPlus07Cnt15.Close();

                        swLogPlus09Cnt4.Close();
                        swLogPlus09Cnt6.Close();
                        swLogPlus09Cnt8.Close();
                        swLogPlus09Cnt10.Close();
                        swLogPlus09Cnt12.Close();
                        swLogPlus09Cnt15.Close();
                        ...
                        swLogAbsoluteEverage20.Close();
                        swLogRelativeEverage20.Close();
                        swLogRelativeMove.Close();
                        swLogAbsoluteMove.Close();
                        swLogAbsoluteMax50.Close();

                        swLogRelativeRecent20.Close();
                        swLogAbsoluteRecent20.Close();
                        swLogRelativeRight20.Close();
                        swLogAbsoluteRight20.Close();

                        swLogTenMinutePower002.Close();
                        swLogTenMinutePower003.Close();
                        swLogTenMinutePower004.Close();
                        swLogTenMinutePower005.Close();
                        swLogTenMinutePower006.Close();

                        swLogContinuosCnt3.Close();
                        swLogContinuosCnt4.Close();
                        swLogContinuosCnt5.Close();
                        swLogContinuosCnt6.Close();

                        swLogTenMinuteCount6.Close();
                        swLogTenMinuteCount7.Close();
                        swLogTenMinuteCount8.Close();
                        swLogTenMinuteCount9.Close();

                        swLogTenMinuteMaxMove002.Close();
                        swLogTenMinuteMaxMove003.Close();
                        swLogTenMinuteMaxMove004.Close();
                        swLogTenMinuteMaxMove005.Close();
                        swLogTenMinuteMaxMove006.Close();

                        swLogContinuosPower002.Close();
                        swLogContinuosPower003.Close();
                        swLogContinuosPower004.Close();
                        swLogContinuosPower005.Close();
                        swLogContinuosPower006.Close();

                        swLogPlus07AndMinus30.Close();
                        swLogPlus07AndMinus50.Close();
                        swLogPlus07AndMinus70.Close();
                        swLogPlus07AndMinus90.Close();
                        swLogPlus07AndMinus110.Close();

                        swLogPlus09AndMinus30.Close();
                        swLogPlus09AndMinus50.Close();
                        swLogPlus09AndMinus70.Close();
                        swLogPlus09AndMinus90.Close();
                        swLogPlus09AndMinus110.Close();
